	...
	<body>
		...
		<div id="show-cliente" class="content scaffold-show" role="main">
			...
			<ol class="property-list cliente">
				...
				<g:if test="${clienteInstance?.rg}">
				<li class="fieldcontain">
					<span id="rg-label" class="property-label"><g:message code="cliente.rg.label" default="Rg" /></span>
					
						<span class="property-value" aria-labelledby="rg-label"><g:fieldValue bean="${clienteInstance}" field="rg"/></span>
